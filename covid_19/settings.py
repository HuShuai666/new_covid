...
SECRET_KEY = 'rzlvegsgoi7i77*gi@cac8i*wi^pr@qi41-@31l9x#7n))n^ko'
...
db_config_path = os.path.dirname(os.path.abspath(__file__))
db_config.read(os.path.join(db_config_path, 'db_config.ini'), encoding="utf-8-sig")
db = db_config['test']
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_RENDERER_CLASSES': (
        'utils.renders.renders.CustomJsonRender',
        'rest_framework.renderers.JSONRenderer',
    ),
    'TEST_REQUEST_DEFAULT_FORMAT': 'json',
    'EXCEPTION_HANDLER': 'utils.handlers.handler.exception_handler',
